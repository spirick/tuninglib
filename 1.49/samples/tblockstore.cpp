...
void TestPackStore ()
  {
    ...
    if (o_packStore. Init (8, 64, 32))
      printf ("Init OK\n");

    char * pc = (char *) o_packStore. Alloc (10);
    printf ("PackStore::Alloc: 10 p%d\n", PtrId (pc));
    pc = (char *) o_packStore. Alloc (33);
    printf ("PackStore::Alloc: 33 p%d\n", PtrId (pc));
    pc = (char *) o_packStore. Alloc (11);
    printf ("PackStore::Alloc: 11 p%d + 16\n", PtrId (pc - 16));
    pc = (char *) o_packStore. Alloc (12);
    printf ("PackStore::Alloc: 12 p%d + 32\n", PtrId (pc - 32));
    pc = (char *) o_packStore. Alloc (13);
    printf ("PackStore::Alloc: 13 p%d + 48\n", PtrId (pc - 48));
    pc = (char *) o_packStore. Alloc (14);
    printf ("PackStore::Alloc: 14 p%d\n", PtrId (pc));
    pc = (char *) o_packStore. Alloc (32);
    printf ("PackStore::Alloc: 32 p%d + 16\n", PtrId (pc - 16));
    pc = (char *) o_packStore. Alloc (15);
    printf ("PackStore::Alloc: 15 p%d + 48\n", PtrId (pc - 48));
    o_packStore. FreeAll (true);
    printf ("PackStore::FreeAll (true)\n");
    pc = (char *) o_packStore. Alloc (4);
    printf ("PackStore::Alloc: 4 p%d\n", PtrId (pc));
    o_packStore. FreeAll (false);
    printf ("PackStore::FreeAll (false)\n");
    pc = (char *) o_packStore. Alloc (5);
...
class ct_TestPackStore2:
  public gct_PackStore <ct_TestStore> { };

void TestPackStore2 ()
  {
    {
    const size_t cusp = sizeof (char *);
    ct_TestPackStore2 o_packStore;

    if (o_packStore. Init (8, 7, 60))
      printf ("Init OK\n");

    char * pc = (char *) o_packStore. Alloc (27);
    printf ("PackStore::Alloc: 27 p%d\n", PtrId (pc - cusp));
    pc = (char *) o_packStore. Alloc (61);
    printf ("PackStore::Alloc: 61 p%d\n", PtrId (pc - cusp));
    pc = (char *) o_packStore. Alloc (28);
    printf ("PackStore::Alloc: 28 p%d + 32\n", PtrId (pc - cusp - 32));
    pc = (char *) o_packStore. Alloc (29);
    printf ("PackStore::Alloc: 29 p%d + 64\n", PtrId (pc - cusp - 64));
    pc = (char *) o_packStore. Alloc (15);
    printf ("PackStore::Alloc: 15 p%d + 96\n", PtrId (pc - cusp - 96));
    pc = (char *) o_packStore. Alloc (30);
    printf ("PackStore::Alloc: 30 p%d\n", PtrId (pc - cusp));
    pc = (char *) o_packStore. Alloc (60);
    printf ("PackStore::Alloc: 60 p%d + 32\n", PtrId (pc - cusp - 32));
    pc = (char *) o_packStore. Alloc (14);
    printf ("PackStore::Alloc: 14 p%d + 96\n", PtrId (pc - cusp - 96));
    o_packStore. FreeAll (true);
    printf ("PackStore::FreeAll (true)\n");
    pc = (char *) o_packStore. Alloc (4);
    printf ("PackStore::Alloc: 4 p%d\n", PtrId (pc - cusp));
