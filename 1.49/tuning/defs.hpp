...
// Log2 functions
  ...
  inline unsigned tl_Log2 (t_UInt32 u)
    {
    unsigned long res;
    _BitScanReverse (& res, u);
    return res;
    }

  #if defined TL_64

  inline unsigned tl_Log2 (t_UInt64 u)
    {
    unsigned long res;
