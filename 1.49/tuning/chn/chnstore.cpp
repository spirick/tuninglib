...
t_Size o_size
  ...
  #if defined TL_64
  unsigned u_idx = tl_Log2 ((t_UInt64) (o_size + StoreInfoSize () - 1u)) - 3u;
  #else
  unsigned u_idx = tl_Log2 ((t_UInt32) (o_size + StoreInfoSize () - 1u)) - 3u;
  #endif
...
t_Size o_size
  ...
  #if defined TL_64
  unsigned u_newIdx = tl_Log2 ((t_UInt64) (o_size + StoreInfoSize () - 1u)) - 3u;
  #else
  unsigned u_newIdx = tl_Log2 ((t_UInt32) (o_size + StoreInfoSize () - 1u)) - 3u;
  #endif
